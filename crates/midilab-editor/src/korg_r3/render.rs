...
use crate::korg_r3::message::UiEffect;
use crate::korg_r3::state::EditorTab;
use crate::korg_r3::state::TimbreSelect;
use crate::korg_r3::state::UiState;
...
fn render_settings_modal(ctx: &Context, ui_state: &mut UiState, outbox: &mut Vec<UiEffect>) {
    let response = Modal::new(egui::Id::new("settings_modal")).show(ctx, |ui| {
            ...
            .changed()
        {
            ...
            let config = crate::korg_r3::config::AppConfig {
                persistence_path: ui_state.configured_directory.clone(),
                user: ui_state.user_settings.clone(),
            };
            let config_path = crate::korg_r3::config::AppConfig::config_path()
    ...
    egui::Panel::left("device_panel")
        ...
        .show(ui, |ui| {
            ...
            let dot_color = match &ui_state.user_msg {
                Some(s) => match s.kind {
                    crate::korg_r3::message::UserMsgKind::Status => egui::Color32::GREEN,
                    crate::korg_r3::message::UserMsgKind::Error => egui::Color32::RED,
                },
